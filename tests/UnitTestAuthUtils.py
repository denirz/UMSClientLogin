...
'''
import unittest
from UMSClientLogin.UMSClientLogin import InsertRandInString,GetAuthParams
#import UMSClientLogin
from UMSClientLogin.ParseOptions import  ParseOptions
#from UMSClientLogin.GetMessagesList import Jsession

class TestGetAuthParams(unittest.TestCase):

    def test_CorrectLogin(self):
        (session,umscsrf)=GetAuthParams('9262001222', '609177')
#        print len(umscsrf),len(session)
        ...
        (session,umscsrf)=GetAuthParams('79262001222', '609177')
#        print umscsrf
    ...
    def test_WrongPassword(self):
        (session,umscsrf)=GetAuthParams('79262001222', '60917e')
